...
generator.load_state_dict(torch.load('bullx2_generatorv7_vii_len10.pth', map_location=device))
generator.eval()

# --- Load quantile transformers ---
quantile_transformer_r1 = load('bullx2_quantile_transformer_r1_len10.joblib')
quantile_transformer_r2 = load('bullx2_quantile_transformer_r2_len10.joblib')
...
all_df.to_feather('synthetic_bullx2_candles_len10.feather')
