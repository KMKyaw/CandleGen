...
generator.load_state_dict(torch.load('flat_generatorv7_vii_len30.pth', map_location=device))
generator.eval()

quantile_transformer_r1 = load('flat_quantile_transformer_r1_len30.joblib')
quantile_transformer_r2 = load('flat_quantile_transformer_r2_len30.joblib')
...
all_df.to_csv('synthetic_flat_candles_len30.csv')
