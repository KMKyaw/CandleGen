...
df = pd.read_feather('../data/bearx2v7.feather')
...
all_df.to_feather('synthetic_bearx2_candles.feather')
...
def prepare_sequences(df, seq_length=20):
    ...
    # bearx2ten all r1 and r2 values for global quantile transform
...
# bearx2ten_c_chunks_df = np.concatenate(c_chunks_df)

# plt.figure(figsize=(10, 6))
# plt.hist(all_c_values, bins=50, color='skyblue', edgecolor='black', alpha=0.5)
# plt.hist(bearx2ten_c_chunks_df, bins=50, color='green', edgecolor='black', alpha=0.5)
