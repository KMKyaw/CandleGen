...
generator.load_state_dict(torch.load('bearx2_generatorv7_vii_len10.pth', map_location=device))
generator.eval()

quantile_transformer_r1 = load('bearx2_quantile_transformer_r1_len10.joblib')
quantile_transformer_r2 = load('bearx2_quantile_transformer_r2_len10.joblib')
...
all_df.to_csv('synthetic_bearx2_candles_len10.csv')
