...
generator.load_state_dict(torch.load('bull_generatorv7_vii.pth', map_location=device))
generator.eval()

# --- Load quantile transformers ---
quantile_transformer_r1 = load('bull_quantile_transformer_r1.joblib')
quantile_transformer_r2 = load('bull_quantile_transformer_r2.joblib')

df = pd.read_feather('../data/bullv7.feather')
